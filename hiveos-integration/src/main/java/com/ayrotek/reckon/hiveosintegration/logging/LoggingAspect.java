...
public class LoggingAspect {
    ...
    public Object logAllMethods(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if (startMsg != null) {
            ...
            log.debug("→ START: {}.{}() | Args: {}", cls, method, safeArgs);
        }
        ...
        try {
            ...
            if (successMsg != null) {
                ...
                log.debug("← SUCCESS: {}.{}() | {} ms | Return: {}", cls, method, elapsed, safeReturn);
            }
            ...
            log.debug("✖ FAILURE: {}.{}() | {} ms | Exception: {}", cls, method, elapsed, t.getMessage());
            throw t;
        } finally {
